...
export default function Home() {
  ...
  const handleDrawCardAndFetchreading = async () => {
    ...
    try {
      ...
      let contract = await tronWeb.contract(abi.entrys, 'TL7WnVKwtq5sUkFUtQtoD65tjX8m4X32Kt'); 
    ...
    // const Allevents = await tronWeb.event.getEventsByContractAddress('TL7WnVKwtq5sUkFUtQtoD65tjX8m4X32Kt', {
  ...
  const mintreading = async () => {
    ...
    try {
      ...
      let contractmint = await tronWeb.contract(abi.entrys, 'TL7WnVKwtq5sUkFUtQtoD65tjX8m4X32Kt'); 
