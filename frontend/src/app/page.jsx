...
export default function Home() {
  ...
  const handleDrawCardAndFetchreading = async () => {
    ...
    try {
      ...
      let contract = await tronWeb.contract(abi.entrys, 'TNUQqQQpchG2k6uCt8mQLPmwh6wYHFZWri'); 
    ...
    // const Allevents = await tronWeb.event.getEventsByContractAddress('TNUQqQQpchG2k6uCt8mQLPmwh6wYHFZWri', {
  ...
  const mintreading = async () => {
    ...
    try {
      ...
      let contractmint = await tronWeb.contract(abi.entrys, 'TNUQqQQpchG2k6uCt8mQLPmwh6wYHFZWri'); 
